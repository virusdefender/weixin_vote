...
if(arguments.length)ta||(1!==s.type&&(b=$b(s,c,b,d)),$a(f,b)||(e[c]=b,g.$digest?s.pedding||(s.pedding=!0,setTimeout(function(){ka(g[c]);d.$events&&V.$fire.call(d,c,e[c],f);s.pedding=!1})):(ka(g[c]),d.$events&&V.$fire.call(d,c,b,f))));else{if(0===s.type)return e[c]=s.get.call(d);dc(g[c]);return s.svmodel||f}};"object"===l&&T(e.get)&&2>=Object.keys(e).length?(s.set=e.set,s.get=e.get,s.type=0,k.push(function(){var b={evaluator:function(){b.element=null;b.type=new Date-0;d[c]=s.get.call(f)},element:F,
type:new Date-0,handler:A,args:[]};ca[D]=b;s.call(f);delete ca[D]})):ab.test(l)?(s.type=2,s.valueType=l,k.push(function(){var b=L(e,0,d[c]);s.svmodel=b;b.$events[G]=g[c]})):s.type=1;s._name=c;h[c]=s}})(e,b[e]);ra.forEach(function(c){delete b[c];delete d[c]});var f=ua(f,ec(h),b),l;for(l in b)h[l]||(f[l]=b[l]);f.$id=M();f.$model=d;f.$events=g;for(e in V)c=V[e],z||(c=c.bind(f)),f[e]=c;va?Object.defineProperty(f,"hasOwnProperty",{value:function(b){return b in this.$model},writable:!1,enumerable:!1,configurable:!0}):
f.hasOwnProperty=function(b){return b in f.$model};k.forEach(function(b){b()});return f}function ac(b,c,d,e){var f=b[c];if("array"===e){if(!Array.isArray(d)||f===d)return f;f._.$unwatch();f.clear();f._.$watch();f.pushArray(d.concat());return f}var g=b.$events[c];if(b=f.$events.$withProxyPool)wa(b,"with"),f.$events.$withProxyPool=null;var h=L(d);h.$events[G]=g;sa[h.$id]=function(b){for(;b=g.shift();)(function(b){avalon.nextTick(function(){b.type&&(b.rollback&&b.rollback(),v[b.type](b,b.vmodels))})})(b);
delete sa[h.$id]};return h}function bc(b){var c=[];c.$id=M();c.$model=b;c.$events={};c.$events[G]=[];c._=L({length:b.length});c._.$watch("length",function(b,d){c.$fire("length",b,d)});for(var d in V)c[d]=V[d];avalon.mix(c,bb);return c}function W(b,c,d,e,f,g,h){for(var k=this.length,l=2;--l;){switch(b){case "add":var m=this.$model.slice(c,c+d).map(function(b){return ab.test(avalon.type(b))?b.$id?b:L(b,0,b):b});xa.apply(this,[c,0].concat(m));this._fire("add",c,d);break;case "del":var n=this._splice(c,
d);this._fire("del",c,d)}f&&(b=f,c=g,d=h,l=2,f=0)}this._fire("index",e);this.length!==k&&(this._.length=this.length);return n}function ya(b,c){for(var d={},e=0,f=c.length;e<f;e++){d[e]=b[e];var g=c[e];g in d?(b[e]=d[g],delete d[g]):b[e]=b[g]}}function za(b){ca[D]=b;avalon.openComputedCollect=!0;var c=b.evaluator;if(c)try{var d=fc.test(b.type)?b:c.apply(0,b.args);b.handler(d,b.element,b)}catch(e){delete b.evaluator,c=b.element,3===c.nodeType&&(d=c.parentNode,t.commentInterpolate?d.replaceChild(p.createComment(b.value),
c):c.data=N+b.value+O)}avalon.openComputedCollect=!1;delete ca[D]}function dc(b){var c=ca[D];b&&(c&&avalon.Array.ensure(b,c)&&c.element)&&Aa(c,b)}function Aa(b,c){b.$uuid=b.$uuid||M();c.$uuid=c.$uuid||M();var d={data:b,list:c,$$uuid:b.$uuid+c.$uuid};P[d.$$uuid]||(P[d.$$uuid]=1,P.push(d))}function cb(b){b.element=null;b.rollback&&b.rollback();for(var c in b)b[c]=null}function gc(b){try{if(!b.parentNode)return!0}catch(c){return!0}return b.msRetain?0:1===b.nodeType?"number"===typeof b.sourceIndex?0===
b.sourceIndex:!B.contains(b):!avalon.contains(B,b)}function db(){for(var b=P.length,c=b,d=0,e,f=[],g={},h={};e=P[--b];){var k=e.data;e=k.type;g[e]?g[e]++:(g[e]=1,f.push(e))}var l=!1;f.forEach(function(b){eb[b]!==g[b]&&(h[b]=1,l=!0)});b=c;if(l)for(;e=P[--b];)k=e.data,void 0!==k.element&&(h[k.type]&&gc(k.element))&&(d++,P.splice(b,1),delete P[e.$$uuid],avalon.Array.remove(e.list,k),cb(k),e.data=e.list=null);eb=g;fb=new Date}function ka(b){if(b&&b.length){444<new Date-fb&&"object"===typeof b[0]&&db();
for(var c=la.call(arguments,1),d=b.length,e;e=b[--d];){var f=e.element;f&&f.parentNode&&(e.$repeat?e.handler.apply(e,c):"on"!==e.type&&e.handler((e.evaluator||A).apply(0,e.args||[]),f,e))}}}function gb(b){var c=b.nodeName;return c.toLowerCase()===c&&b.scopeName&&""===b.outerText}function hc(b){"url(#default#VML)"!==b.currentStyle.behavior&&(b.style.behavior="url(#default#VML)",b.style.display="inline-block",b.style.zoom=1)}function ma(b,c,d){var e=setTimeout(function(){var f=b.innerHTML;clearTimeout(e);
f===d?c():ma(b,c,f)})}function hb(b,c){var d=b.getAttribute("avalonctrl")||c.$id;b.setAttribute("avalonctrl",d);c.$events.expr=b.tagName+'[avalonctrl="'+d+'"]'}function Ba(b,c){for(var d=0,e;e=b[d++];)e.vmodels=c,v[e.type](e,c),e.evaluator&&(e.element&&1===e.element.nodeType)&&e.element.removeAttribute(e.name);b.length=0}function ic(b,c){return b.priority-c.priority}function ib(b,c,d){var e=b.getAttribute("ms-skip");if(!b.getAttributeNode)return y("warning "+b.tagName+" no getAttributeNode method");
var f=b.getAttributeNode("ms-important");d=b.getAttributeNode("ms-controller");if("string"!==typeof e){if(d=f||d){e=avalon.vmodels[d.value];if(!e)return;c=d===f?[e]:[e].concat(c);f=d.name;b.removeAttribute(f);avalon(b).removeClass(f);hb(b,e)}jb(b,c)}}function jc(b,c){for(var d=b.firstChild;d;){var e=d.nextSibling;kb(d,d.nodeType,c);d=e}}function na(b,c){for(var d=0,e;e=b[d++];)kb(e,e.nodeType,c)}function kb(b,c,d){1===c?ib(b,d):3===c&&da.test(b.data)?lb(b,d):t.commentInterpolate&&(8===c&&!da.test(b.nodeValue))&&
lb(b,d)}function jb(b,c){for(var d=mb?mb(b):avalon.slice(b.attributes),e=[],f={},g,h=0,k;k=d[h++];)if(k.specified&&(g=k.name.match(nb))){var l=g[1],m=g[2]||"",n=k.value;k=k.name;f[k]=n;kc[l]?(m=l,l="on"):lc[l]&&(y("ms-"+l+"\u5df2\u7ecf\u88ab\u5e9f\u5f03,\u8bf7\u4f7f\u7528ms-attr-*\u4ee3\u66ff"),"enabled"===l&&(l="disabled",n="!("+n+")"),m=l,l="attr",b.removeAttribute(k),k="ms-attr-"+m,b.setAttribute(k,n),g=[k],f[k]=n);if("function"===typeof v[l]){var r={type:l,param:m,element:b,name:g[0],value:n,
priority:l in ob?ob[l]:10*l.charCodeAt(0)+(Number(m)||0)};if("html"===l||"text"===l)m=Ca(n),avalon.mix(r,m),r.filters=r.filters.replace(pb,function(){r.type="html";r.group=1;return""});"ms-if-loop"===k&&(r.priority+=100);c.length&&(e.push(r),"widget"===l&&(b.msData=b.msData||f))}}e.sort(ic);f["ms-attr-checked"]&&f["ms-duplex"]&&y("warning!\u4e00\u4e2a\u5143\u7d20\u4e0a\u4e0d\u80fd\u540c\u65f6\u5b9a\u4e49ms-attr-checked\u4e0ems-duplex");d=!0;for(h=0;r=e[h];h++){l=r.type;if(mc.test(l))return Ba(e.slice(0,
h+1),c);d&&(d=!nc.test(l))}Ba(e,c);d&&(!oc[b.tagName]&&qb.test(b.innerHTML.replace(pc,"<").replace(qc,">")))&&(rb&&rb(b),jc(b,c))}function Ca(b){if(0<b.indexOf("|")){var c=b.replace(rc,"\u1122\u3344").indexOf("|");if(-1<c)return{filters:b.slice(c),value:b.slice(0,c),expr:!0}}return{value:b,filters:"",expr:!0}}function Da(b){var c=[],d;d=0;var e;do{e=b.indexOf(N,d);if(-1===e)break;(d=b.slice(d,e))&&c.push({value:d,filters:"",expr:!1});d=e+N.length;e=b.indexOf(O,d);if(-1===e)break;(d=b.slice(d,e))&&
c.push(Ca(d));d=e+O.length}while(1);(d=b.slice(d))&&c.push({value:d,expr:!1,filters:""});return c}function lb(b,c){var d=[];if(8===b.nodeType)var e=Ca(b.nodeValue),f=[e];else f=Da(b.data);if(f.length){for(var g=0;e=f[g++];){var h=p.createTextNode(e.value);e.expr&&(e.type="text",e.element=h,e.filters=e.filters.replace(pb,function(){e.type="html";e.group=1;return""}),d.push(e));X.appendChild(h)}b.parentNode.replaceChild(X,b);d.length&&Ba(d,c)}}function sb(b){return b.replace(/([a-z\d])([A-Z]+)/g,"$1-$2").toLowerCase()}
...
e;for(e in xb)d[e]=b.style[e],b.style[e]=xb[e];c.push(d)}(d=b.parentNode)&&1===d.nodeType&&wb(d,c)}}function uc(b,c,d,e){for(var f=[],g=" = "+d+".",h=b.length,k;k=b[--h];)c.hasOwnProperty(k)&&(f.push(k+g+k),e.vars.push(k),"duplex"===e.type&&(b.get=d+"."+k),b.splice(h,1));return f}function yb(b){for(var c=[],d={},e=0;e<b.length;e++){var f=b[e],g=f&&"string"===typeof f.$id?f.$id:f;d[g]||(d[g]=c.push(f))}return c}function vc(b,c){c=c.replace(wc,"").replace(xc,function(){return"],|"}).replace(yc,function(b,
c){return"["+zb(c)}).replace(zc,function(){return'"],["'}).replace(Ac,function(){return'",'})+"]";return"return avalon.filters.$filter("+b+", "+c+")"}function Ab(b,c,d){var e=d.type,f=d.filters||"",g=c.map(function(b){return String(b.$id).replace(Bc,"$1")})+b+e+f,h=Cc(b).concat(),k=[],l=[],m=[],n="";c=yb(c);d.vars=[];for(var n=0,r=c.length;n<r;n++)if(h.length){var s="vm"+D+"_"+n;l.push(s);m.push(c[n]);k.push.apply(k,uc(h,c[n],s,d))}if(k.length||"duplex"!==e)if("duplex"!==e&&(-1<b.indexOf("||")||-1<
b.indexOf("&&"))&&d.vars.forEach(function(c){b=b.replace(RegExp("\\b"+c+"(?:\\.\\w+|\\[\\w+\\])+","ig"),function(d,e){var f=d.charAt(c.length),g=Q?b.slice(e+d.length):RegExp.rightContext,g=/^\s*\(/.test(g);if("."===f||"["===f||g){f="var"+String(Math.random()).replace(/^0\./,"");if(g){g=d.split(".");if(2<g.length){var h=g.pop();k.push(f+" = "+g.join("."));return f+"."+h}return d}k.push(f+" = "+d);return f}return d})}),d.args=m,c=Ea[g])d.evaluator=c;else{(n=k.join(", "))&&(n="var "+n);if(/\S/.test(f)){if(!/text|html/.test(d.type))throw Error("ms-"+
d.type+"\u4e0d\u652f\u6301\u8fc7\u6ee4\u5668");b="\nvar ret"+D+" = "+b+";\r\n";b+=vc("ret"+D,f)}else{if("duplex"===e){e="'use strict';\nreturn function(vvv){\n\t"+n+";\n\tif(!arguments.length){\n\t\treturn "+b+"\n\t}\n\t"+(!Dc.test(b)?h.get:b)+"= vvv;\n} ";try{c=Function.apply(A,l.concat(e)),d.evaluator=Ea(g,c)}catch(ba){y("debug: parse error,"+ba.message)}return}"on"===e?(b=-1===b.indexOf("(")?b+".call(this, $event)":b.replace("(",".call(this,"),l.push("$event"),b="\nreturn "+b+";",f=b.lastIndexOf("\nreturn"),
e=b.slice(0,f),f=b.slice(f),b=e+"\n"+f):b="\nreturn "+b+";"}try{c=Function.apply(A,l.concat("'use strict';\n"+n+b)),d.evaluator=Ea(g,c)}catch(cc){y("debug: parse error,"+cc.message)}finally{h=textBuffer=l=null}}}function I(b,c,d,e,f){Array.isArray(e)&&(b=e.map(function(b){return b.expr?"("+b.value+")":zb(b.value)}).join(" + "));Ab(b,c,d);d.evaluator&&!f&&(d.handler=E[d.handlerName||d.type],za(d))}function ea(b,c){var d="_"+b;if(!ea[d]){var e=p.createElement(b);B.appendChild(e);c=z?getComputedStyle(e,
null).display:e.currentStyle.display;B.removeChild(e);ea[d]=c}return ea[d]}function Fa(b){return null==b?"":b}function Ec(b,c,d,e){c.param.replace(/\w+/g,function(e){(e=avalon.duplexHooks[e])&&"function"===typeof e[d]&&(b=e[d](b,c))});return b}function Fc(){for(var b=fa.length-1;0<=b;b--)!1===(0,fa[b])()&&fa.splice(b,1);fa.length||clearInterval(Bb)}function Cb(b,c,d,e){var f=b.template.cloneNode(!0),g=avalon.slice(f.childNodes);d.$stamp&&f.insertBefore(d.$stamp,f.firstChild);c.appendChild(f);b=[d].concat(b.vmodels);
...
return c}function Hc(b,c){for(var d=c.param||"el",e,f=0,g=pa.length;f<g;f++){var h=pa[f];h&&h.hasOwnProperty(d)&&(e=h,pa.splice(f,1))}e||(e=Gc(d));var k=c.$repeat,d=k.length-1;e.$index=b;e.$first=0===b;e.$last=b===d;e.$host=k;e.$outer=c.$outer;e.$stamp=c.clone.cloneNode(!1);e.$remove=function(){return k.removeAt(e.$index)};return e}function Ic(){var b=L({$key:"",$outer:{},$host:{},$val:{get:function(){return this.$host[this.$key]},set:function(b){this.$host[this.$key]=b}}},{$val:1});b.$id=M("$proxy$with");
return b}function Jc(b,c){var d=Eb.pop();d||(d=Ic());var e=c.$repeat;d.$key=b;d.$host=e;d.$outer=c.$outer;e.$events?d.$events.$val=e.$events[b]:d.$events={};return d}function wa(b,c){var d="each"===c?pa:Eb;avalon.each(b,function(b,c){if(c.$events){for(var g in c.$events)Array.isArray(c.$events[g])&&(c.$events[g].forEach(function(b){"object"===typeof b&&cb(b)}),c.$events[g].length=0);c.$host=c.$outer={};d.unshift(c)>t.maxRepeatSize&&d.pop()}});"each"===c&&(b.length=0)}function Fb(b,c,d,e){b=(b+"").replace(/[^0-9+\-Ee.]/g,
"");b=!isFinite(+b)?0:+b;c=!isFinite(+c)?0:Math.abs(c);e="undefined"===typeof e?",":e;d="undefined"===typeof d?".":d;var f="",f=function(b,c){var d=Math.pow(10,c);return""+(Math.round(b*d)/d).toFixed(c)},f=(c?f(b,c):""+Math.round(b)).split(".");3<f[0].length&&(f[0]=f[0].replace(/\B(?=(?:\d{3})+(?!\d))/g,e));if((f[1]||"").length<c)f[1]=f[1]||"",f[1]+=Array(c-f[1].length+1).join("0");return f.join(d)}function U(){p.body&&(C?(u["ready!"].state=2,C.checkDeps()):Gb.forEach(function(b){b(avalon)}),U=A)}
function Hb(){try{B.doScroll("left"),U()}catch(b){setTimeout(Hb)}}var D=new Date-0,p=q.document,F=p.getElementsByTagName("head")[0],ga=F.insertBefore(document.createElement("avalon"),F.firstChild);ga.innerHTML="X<style id='avalonStyle'>.avalonHide{ display: none!important }</style>";ga.setAttribute("ms-skip","1");var Ib=/\[native code\]/,G="$"+D,Kc=q.require,Lc=q.define,ta=!1,w=/[^, ]+/g,ab=/^(?:object|array)$/,Ha=/^\[object SVG\w*Element\]$/,Wb=/^\[object (?:Window|DOMWindow|global)\]$/,Ia=Object.prototype,
K=Ia.hasOwnProperty,$=Ia.toString,J=Array.prototype,la=J.slice,ca={},z=q.dispatchEvent,B=p.documentElement,X=p.createDocumentFragment(),ha=p.createElement("div"),Jb={};"Boolean Number String Function Array Date RegExp Object Error".replace(w,function(b){Jb["[object "+b+"]"]=b.toLowerCase()});var M=function(b){return((b||"avalon")+Math.random()+Math.random()).replace(/0\./g,"")},Q=function(){if(q.VBArray){var b=document.documentMode;return b?b:q.XMLHttpRequest?7:6}return 0}();avalon=function(b){return new avalon.init(b)};
avalon.init=function(b){this[0]=this.element=b};avalon.fn=avalon.prototype=avalon.init.prototype;avalon.type=function(b){return null==b?String(b):"object"===typeof b||"function"===typeof b?Jb[$.call(b)]||"object":typeof b};var T="object"===typeof alert?function(b){try{return/^\s*\bfunction\b/.test(b+"")}catch(c){return!1}}:function(b){return"[object Function]"==$.call(b)};avalon.isFunction=T;avalon.isWindow=function(b){return!b?!1:b==b.document&&b.document!=b};Wa(q)&&(avalon.isWindow=Wa);for(var Mc in avalon({}))break;
var Nc="0"!==Mc;avalon.isPlainObject=function(b,c){if(!b||"object"!==avalon.type(b)||b.nodeType||avalon.isWindow(b))return!1;try{if(b.constructor&&!K.call(b,"constructor")&&!K.call(b.constructor.prototype,"isPrototypeOf"))return!1}catch(d){return!1}if(Nc)for(c in b)return K.call(b,c);for(c in b);return void 0===c||K.call(b,c)};Ib.test(Object.getPrototypeOf)&&(avalon.isPlainObject=function(b){return"[object Object]"===$.call(b)&&Object.getPrototypeOf(b)===Ia});avalon.mix=avalon.fn.mix=function(){var b,
c,d,e,f,g=arguments[0]||{},h=1,k=arguments.length,l=!1;"boolean"===typeof g&&(l=g,g=arguments[1]||{},h++);"object"!==typeof g&&!T(g)&&(g={});h===k&&(g=this,h--);for(;h<k;h++)if(null!=(b=arguments[h]))for(c in b){d=g[c];try{e=b[c]}catch(m){continue}g!==e&&(l&&e&&(avalon.isPlainObject(e)||(f=Array.isArray(e)))?(f?(f=!1,d=d&&Array.isArray(d)?d:[]):d=d&&avalon.isPlainObject(d)?d:{},g[c]=avalon.mix(l,d,e)):void 0!==e&&(g[c]=e))}return g};avalon.mix({rword:w,subscribers:G,version:1.39,ui:{},log:y,slice:z?
...
/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g;String.prototype.trim=function(){return this.replace(Oc,"")}}var Pc=!{toString:null}.propertyIsEnumerable("toString"),Qc=function(){}.propertyIsEnumerable("prototype"),Kb="toString toLocaleString valueOf hasOwnProperty isPrototypeOf propertyIsEnumerable constructor".split(" "),Rc=Kb.length;Object.keys||(Object.keys=function(b){var c=[],d=Qc&&"function"===typeof b;if("string"===typeof b||b&&b.callee)for(d=0;d<b.length;++d)c.push(String(d));else for(var e in b)!(d&&
"prototype"===e)&&K.call(b,e)&&c.push(String(e));if(Pc){d=(d=b.constructor)&&d.prototype===b;for(e=0;e<Rc;e++){var f=Kb[e];!(d&&"constructor"===f)&&K.call(b,f)&&c.push(f)}}return c});Array.isArray||(Array.isArray=function(b){return"[object Array]"===$.call(b)});A.bind||(Function.prototype.bind=function(b){if(2>arguments.length&&void 0===b)return this;var c=this,d=arguments;return function(){var e=[],f;for(f=1;f<d.length;f++)e.push(d[f]);for(f=0;f<arguments.length;f++)e.push(arguments[f]);return c.apply(b,
e)}});Ib.test([].map)||avalon.mix(J,{indexOf:function(b,c){var d=this.length,e=~~c;for(0>e&&(e+=d);e<d;e++)if(this[e]===b)return e;return-1},lastIndexOf:function(b,c){var d=this.length,e=null==c?d-1:c;for(0>e&&(e=Math.max(0,d+e));0<=e;e--)if(this[e]===b)return e;return-1},forEach:aa("","_",""),filter:aa("r=[],j=0,","if(_)r[j++]=this[i]","return r"),map:aa("r=[],","r[i]=_","return r"),some:aa("","if(_)return true","return false"),every:aa("","if(!_)return false","return true")});avalon.contains=Ya;
B.contains||(Node.prototype.contains=function(b){return!!(this.compareDocumentPosition(b)&16)});p.contains||(p.contains=function(b){return Ya(p,b)});if(q.SVGElement){var Lb=p.createElementNS("http://www.w3.org/2000/svg","svg");Lb.innerHTML='<circle cx="50" cy="50" r="40" fill="red" />';if(!Ha.test(Lb.firstChild)){var Ja=function(b,c){if(b&&b.childNodes)for(var d=b.childNodes,e=0,f;f=d[e++];)if(f.tagName){var g=p.createElementNS("http://www.w3.org/2000/svg",f.tagName.toLowerCase());J.forEach.call(f.attributes,
...
this.nodeName+'\\b(?:(["\'])[^"]*?(\\1)|[^>])*>',"i"),"").replace(b,"")},set:function(b){avalon.clearHTML&&(avalon.clearHTML(this),b=avalon.parseHTML(b),Ja(b,this))}}})}}!B.outerHTML&&q.HTMLElement&&HTMLElement.prototype.__defineGetter__("outerHTML",Za);var Yb=/^(?:mouse|contextmenu|drag)|click/,ia=avalon.eventHooks;"onmouseenter"in B||avalon.each({mouseenter:"mouseover",mouseleave:"mouseout"},function(b,c){ia[b]={type:c,deel:function(c,e){return function(f){var g=f.relatedTarget;if(!g||g!==c&&!(c.compareDocumentPosition(g)&
16))return delete f.type,f.type=b,e.call(c,f)}}}});avalon.each({AnimationEvent:"animationend",WebKitAnimationEvent:"webkitAnimationEnd"},function(b,c){q[b]&&!ia.animationend&&(ia.animationend={type:c})});"oninput"in p.createElement("input")||(ia.input={type:"propertychange",deel:function(b,c){return function(d){if("value"===d.propertyName)return d.type="input",c.call(b,d)}}});if(void 0===p.onmousewheel){var Mb=void 0!==p.onwheel?"wheel":"DOMMouseScroll",Sc="wheel"===Mb?"deltaY":"detail";ia.mousewheel=
{type:Mb,deel:function(b,c){return function(d){d.wheelDeltaY=d.wheelDelta=0<d[Sc]?-120:120;d.wheelDeltaX=0;Object.defineProperty&&Object.defineProperty(d,"type",{value:"mousewheel"});c.call(b,d)}}}}var N,O,da,Nb,qb,Ob=/[-.*+?^${}()|[\]\/\\]/g,C=A,R={loader:function(b){q.define=b?C.define:Lc;q.require=b?C:Kc},interpolate:function(b){N=b[0];O=b[1];if(N===O)throw new SyntaxError("openTag!==closeTag");if("\x3c!--,--\x3e"===b+"")t.commentInterpolate=!0;else{b=N+"test"+O;ha.innerHTML=b;if(ha.innerHTML!==
b&&-1<ha.innerHTML.indexOf("&lt;"))throw new SyntaxError("\u6b64\u5b9a\u754c\u7b26\u4e0d\u5408\u6cd5");ha.innerHTML=""}b=(N+"").replace(Ob,"\\$&");var c=(O+"").replace(Ob,"\\$&");da=RegExp(b+"(.*?)"+c);Nb=RegExp(b+"(.*?)"+c,"g");qb=RegExp(b+".*?"+c+"|\\sms-")}};t.debug=!0;t.plugins=R;t.plugins.interpolate(["{{","}}"]);t.paths={};t.shim={};t.maxRepeatSize=100;avalon.config=t;var V={$watch:function(b,c){if("function"===typeof c){var d=this.$events[b];d?d.push(c):this.$events[b]=[c]}else this.$events=
...
b=f.join("\r\n");b=q.findOrDefineVBClass(e,b);b===e&&q.parseVB(["Function "+e+"Factory(a, b)","\tDim o","\tSet o = (New "+e+")(a, b)","\tSet "+e+"Factory = o","End Function"].join("\r\n"));return q[b+"Factory"](c,Uc)}}var xa=J.splice,bb={_splice:xa,_fire:function(b,c,d){ka(this.$events[G],b,c,d)},size:function(){return this._.length},pushArray:function(b){var c=b.length,d=this.length;c&&(J.push.apply(this.$model,b),W.call(this,"add",d,c,d));return c+d},push:function(){var b,c=arguments.length;for(b=
...
e=Math.random(),f=[],g;J[b].apply(c,arguments);for(var h=0,k=d.length;h<k;h++){var l=c[h];$a(l,d[h])?f.push(h):(g=d.indexOf(l),f.push(g),d[g]=e,g=!0)}g&&(ya(this,f),this._fire("move",f),this._fire("index",0));return this}});var fc=/^(duplex|on)$/,P=avalon.$$subscribers=[],fb=new Date,eb={},H={area:[1,"<map>"],param:[1,"<object>"],col:[2,"<table><tbody></tbody><colgroup>","</table>"],legend:[1,"<fieldset>"],option:[1,"<select multiple='multiple'>"],thead:[1,"<table>","</table>"],tr:[2,"<table><tbody>",
...
Sa=function(){return new (q.XMLHttpRequest||ActiveXObject)("Microsoft.XMLHTTP")},Ta=avalon.templateCache={};v.attr=function(b,c){var d=b.value.trim(),e=!0;-1<d.indexOf(N)&&2<d.indexOf(O)&&(e=!1,da.test(d)&&(""===RegExp.rightContext&&""===RegExp.leftContext)&&(e=!0,d=RegExp.$1));if("include"===b.type){var f=b.element;b.includeRendered=ja(f,"data-include-rendered",c);b.includeLoaded=ja(f,"data-include-loaded",c);var g=b.includeReplaced=!!avalon(f).data("includeReplace");b.startInclude=p.createComment("ms-include");
...
for(var f=(n.responseText||"").match(rd)||[],e=f.length,s=0;s<e;s++){var ba=c[s];ba&&(ba.style.display="none",ba.fixIE78=(f[s].match(sd)||["","&nbsp;"])[1])}}avalon.nextTick(function(){m(r.fixIE78||r.value||r.innerText||r.innerHTML)})}}}else{if(!B.hasAttribute&&"string"===typeof b&&("src"===e||"href"===e))b=b.replace(/&amp;/g,"&");c[e]=b;q.chrome&&"EMBED"===c.tagName&&(f=c.parentNode,e=document.createComment("ms-src"),f.replaceChild(e,c),f.replaceChild(c,e))}};"title,alt,src,value,css,include,href".replace(w,
function(b){v[b]=v.attr});v["class"]=function(b,c){var d=b.param,e=b.value;b.handlerName="class";if(!d||isFinite(d)){b.param="";var f=e.replace(Nb,function(b){return b.replace(/./g,"0")}).indexOf(":");if(-1===f)d=e;else if(d=e.slice(0,f),e=e.slice(f+1),Ab(e,c,b),b.evaluator)b._evaluator=b.evaluator,b._args=b.args;else return y("debug: ms-class '"+(e||"").trim()+"' \u4e0d\u5b58\u5728\u4e8eVM\u4e2d"),!1;e=da.test(d);e||(b.immobileClass=d);I("",c,b,e?Da(d):0)}else b.immobileClass=b.oldStyle=b.param,
...
b);(b.pipe||(b.pipe=Ec))(null,b,"init");h=d.tagName;Y[h]&&Y[h](d,b.evaluator.apply(null,b.args),b)}};avalon.duplexHooks={checked:{get:function(b,c){return!c.element.oldValue}},string:{get:function(b){return b},set:Fa},"boolean":{get:function(b){return"true"===b},set:Fa},number:{get:function(b){return isFinite(b)?parseFloat(b)||0:b},set:Fa}};var Bb,fa=[];avalon.tick=function(b){1===fa.push(b)&&(Bb=setInterval(Fc,60))};var Vb=A;new function(){try{var b={},c=HTMLInputElement.prototype,d=HTMLTextAreaElement.prototype,
e=function(c){avalon.contains(B,this)&&(b[this.tagName].call(this,c),this.avalonSetter&&this.avalonSetter())};Object.getOwnPropertyNames(HTMLInputElement.prototype);b.INPUT=Object.getOwnPropertyDescriptor(c,"value").set;Object.defineProperty(c,"value",{set:e});b.TEXTAREA=Object.getOwnPropertyDescriptor(d,"value").set;Object.defineProperty(d,"value",{set:e})}catch(f){Vb=avalon.tick}};Q&&avalon.bind(p,"selectionchange",function(b){(b=p.activeElement)&&"function"===typeof b.avalonSetter&&b.avalonSetter()});
Y.INPUT=function(b,c,d){function e(b){d.changed.call(this,b,d)}function f(){n=!0}function g(){n=!1}function h(){if(!n){var f=b.oldValue=b.value,f=d.pipe(f,d,"get");!1!==m.data("duplex-observe")&&(c(f),e.call(b,f),m.data("duplex-focus")&&avalon.nextTick(function(){b.focus()}))}}var k=b.type,l=d.bound,m=avalon(b),n=!1;d.handler=function(){var e=d.pipe(c(),d,"set");e!==b.oldValue&&(b.value=e)};if(d.isChecked||"radio"===b.type){var r=6===Q,h=function(){if(!1!==m.data("duplex-observe")){var f=d.pipe(b.value,
d,"get");c(f);e.call(b,f)}};d.handler=function(){var e=c(),f=d.isChecked?!!e:e+""===b.value;b.oldValue=f;r?setTimeout(function(){b.defaultChecked=f;b.checked=f},100):b.checked=f};l(r?"mouseup":"click",h)}else if("checkbox"===k)h=function(){if(!1!==m.data("duplex-observe")){var f=b.checked?"ensure":"remove",g=c();Array.isArray(g)||(y("ms-duplex\u5e94\u7528\u4e8echeckbox\u4e0a\u8981\u5bf9\u5e94\u4e00\u4e2a\u6570\u7ec4"),g=[g]);avalon.Array[f](g,d.pipe(b.value,d,"get"));e.call(b,g)}},d.handler=function(){var e=
[].concat(c());b.checked=-1<e.indexOf(d.pipe(b.value,d,"get"))},l(z?"change":"click",h);else{k=b.getAttribute("data-duplex-event")||b.getAttribute("data-event")||"input";b.attributes["data-event"]&&y("data-event\u6307\u4ee4\u5df2\u7ecf\u5e9f\u5f03\uff0c\u8bf7\u6539\u7528data-duplex-event");var s=function(b){setTimeout(function(){h(b)})};k.replace(w,function(b){switch(b){case "input":Q?(8<Q?l("input",h):l("propertychange",function(b){"value"===b.propertyName&&h()}),l("dragend",s)):(l("input",h),l("compositionstart",
...
1:"\u5468\u4e00",2:"\u5468\u4e8c",3:"\u5468\u4e09",4:"\u5468\u56db",5:"\u5468\u4e94",6:"\u5468\u516d"},fullDate:"y\u5e74M\u6708d\u65e5EEEE",longDate:"y\u5e74M\u6708d\u65e5",medium:"yyyy-M-d H:mm:ss",mediumDate:"yyyy-M-d",mediumTime:"H:mm:ss","short":"yy-M-d ah:mm",shortDate:"yy-M-d",shortTime:"ah:mm"};m.SHORTMONTH=m.MONTH;Ua.date.locate=m};var u=avalon.modules={"ready!":{exports:avalon},avalon:{exports:avalon,state:2}};u.exports=u.avalon;new function(){function b(b){return(b||"").replace(/[?#].*/,
"")}function c(b){return t.baseUrl?t.baseUrl:b?b.substr(0,b.lastIndexOf("/")):t.loaderUrl}function d(b){var c;try{a.b.c()}catch(d){c=d.stack,!c&&q.opera&&(c=(String(d).match(/of linked script \S+/g)||[]).join(" "))}if(c)return c=c.split(/[@ ]/g).pop(),c="("===c[0]?c.slice(1,-1):c.replace(/\s/,""),c.replace(/(:\d+)?:\d+$/i,"");for(var e=(b?p:F).getElementsByTagName("script"),f=e.length;c=e[--f];)if((b||c.className===G)&&"interactive"===c.readyState)return b="1"[0]?c.src:c.getAttribute("src",4),c.className=
b}function e(b,c){for(var d in b)if("\u53f8\u5f92\u6b63\u7f8e"===b[d]&&2!==u[d].state&&(d===c||e(u[d].deps,c)))return!0}function f(){var b=v.length,c;a:for(;c=v[--b];){var d=u[c];c=d.deps;for(var e in c)if(K.call(c,e)&&2!==u[e].state)continue a;if(2!==d.state){v.splice(b,1);c=d.id;var g=d.args,d=d.factory,h=Object(u[c]);h.state=2;for(var k=0,l=[],m=void 0;m=g[k++];)"exports"===m?(m=h.exports||(h.exports={}),l.push(m)):l.push(u[m].exports);g=d.apply(q,l);void 0!==g&&(u[c].exports=g);f()}}}function g(c,
d,e){var f=b(c.src);c.onload=c.onreadystatechange=c.onerror=null;if(d||e&&!u[f].state)setTimeout(function(){F.removeChild(c);c=null}),y("debug: \u52a0\u8f7d "+f+" \u5931\u8d25"+d+" "+!u[f].state);else return!0}function h(b,c){var d=p.getElementsByTagName("base")[0],e=d&&d.href,f=d||F.appendChild(p.createElement("base")),g=p.createElement("a");f.href=c;g.href=b;try{return"1"[0]?g.href:g.getAttribute("href",4)}finally{d?d.href=e:F.removeChild(f)}}function k(b,c){"/"!==b.charAt(b.length-1)&&(b+="/");
if("./"===c.slice(0,2))return b+c.slice(2);if(".."===c.slice(0,2)){for(b+=c;B.test(b);)b=b.replace(B,"");return b}return"/"===c.slice(0,1)?b+c.slice(1):b+c}function l(b){return function(){var c;b.init&&(c=b.init.apply(q,arguments));return c||b.exports&&n(b.exports)}}function m(b,c,d,e,f){return{id:b,state:c||1,factory:d||A,deps:e||{},args:f||[]}}function n(b){if(!b)return b;var c=q;b.split(".").forEach(function(b){c=c[b]});return c}function r(d,e){if("ready!"===d||u[d]&&2===u[d].state)return d;var f;
d=d.replace(/^\w+!/,function(b){f=b.slice(0,-1);return""});f=f||"js";f=R[f]||A;var g=t.shim[d];if("object"===typeof g&&(Array.isArray(g)&&(g=t.shim[d]={deps:g}),!g.exportsFn&&(g.exports||g.init)))g.exportsFn=l(g);d=d.split("/");for(var m=d.length,n;0<m;m-=1)if(n=d.slice(0,m).join("/"),n=t.paths[n]){Array.isArray(n)&&(n=n[0]);d.splice(0,m,n);break}d=d.join("/");d=b(d);(m=f.ext)&&d.slice(0-m.length)!==m&&(d+=m);/^(?:[a-z]+:)?\/\//i.test(String(d))||(d=k(e,d),/^(?:[a-z]+:)?\/\//i.test(String(d))||(d=
h(d,c())));t.nocache&&(d+=(-1===d.indexOf("?")?"?":"&")+(new Date-0));return f(d,g)}function s(b,c,d){var e=p.createElement("script");e.className=G;e[z?"onload":"onreadystatechange"]=function(){if(z||/loaded|complete/i.test(e.readyState)){var h=x.pop();h&&h.require(c);d&&d();g(e,!1,!z)&&(y("debug: \u5df2\u6210\u529f\u52a0\u8f7d "+b),v.push(c),f())}};e.onerror=function(){g(e,!0)};e.src=b;F.insertBefore(e,F.firstChild);y("debug: \u6b63\u51c6\u5907\u52a0\u8f7d "+b)}var v=[],x=[],w=d(!0);w||(w=p.scripts[p.scripts.length-
1].src);w=b(w);t.loaderUrl=w.slice(0,w.lastIndexOf("/")+1);C=avalon.require=function(b,d,e){Array.isArray(b)||avalon.error("require\u7684\u7b2c\u4e00\u4e2a\u53c2\u6570\u5fc5\u987b\u662f\u4f9d\u8d56\u5217\u6570,\u7c7b\u578b\u4e3a\u6570\u7ec4 "+b);var g=[],h={},k=e||"callback"+setTimeout("1");e=c(e);b.forEach(function(b){if((b=r(b,e))&&!h[b])g.push(b),h[b]="\u53f8\u5f92\u6b63\u7f8e"});u[k]||v.push(k);if(!u[k]||2!==u[k].state)u[k]=m(k,1,d,h,g);f()};C.define=function(c,f,g){var h=la.call(arguments);if("string"===
typeof c)var k=h.shift();"function"===typeof h[0]&&h.unshift([]);var l=u[k]&&1<=u[k].state?k:b(d());g=h[1];g.id=k;!u[l]&&k&&(u[l]=m(l,1,g));g.require=function(b){h.push(b);var c=!0;try{c=e(u[b].deps,b)}catch(d){}c&&avalon.error(b+"\u6a21\u5757\u4e0e\u4e4b\u524d\u7684\u6a21\u5757\u5b58\u5728\u5faa\u73af\u4f9d\u8d56\uff0c\u8bf7\u4e0d\u8981\u76f4\u63a5\u7528script\u6807\u7b7e\u5f15\u5165"+b+"\u6a21\u5757");delete g.require;C.apply(null,h)};l?g.require(l):x.push(g)};C.define.amd=u;var B=/\/\w+\/\.\./;
t.packages=[];t.pkgs={};jsSuffixRegExp=/\.js$/;currDirRegExp=/^\.\//;R.packages=function(b){for(var c=0;c<b.length;c++){var d=b[c],d="string"===typeof d?{name:d}:d,e=d.name;d.location&&(t.paths[e]=d.location);t.pkgs[e]=d.name+"/"+(d.main||"main").replace(currDirRegExp,"").replace(jsSuffixRegExp,"")}};R.js=function(c,d){var e=b(c);if(!u[e]){var f=u[e]=m(e);d?C(d.deps||[],function(){var b=avalon.slice(arguments);s(c,e,function(){f.state=2;d.exportsFn&&(f.exports=d.exportsFn.apply(0,b));C.checkDeps()})}):
s(c,e)}return e};R.css=function(c){var d=b(c).replace(/\W/g,"_");if(!p.getElementById(d)){var e=p.createElement("link");e.rel="stylesheet";e.href=c;e.id=d;F.insertBefore(e,F.firstChild)}};R.css.ext=".css";R.js.ext=".js";R.text=function(c){var d=Sa(),e=b(c);u[e]={};d.onreadystatechange=function(){if(4===d.readyState){var b=d.status;399<b&&600>b?avalon.error(c+" \u5bf9\u5e94\u8d44\u6e90\u4e0d\u5b58\u5728\u6216\u6ca1\u6709\u5f00\u542f CORS"):(u[e].state=2,u[e].exports=d.responseText,C.checkDeps())}};
d.open("GET",c,!0);"withCredentials"in d&&(d.withCredentials=!0);d.setRequestHeader("X-Requested-With","XMLHttpRequest");d.send();return e};C.config=t;C.checkDeps=f};var Gb=[];if("complete"===p.readyState)setTimeout(U);else if(z)p.addEventListener("DOMContentLoaded",U);else{p.attachEvent("onreadystatechange",function(){"complete"===p.readyState&&U()});var Va;try{Va=null!=q.frameElement}catch(Bd){Va=!0}B.doScroll&&!Va&&Hb()}avalon.bind(q,"load",U);avalon.ready=function(b){C?C(["ready!"],b):U===A?b(avalon):
Gb.push(b)};avalon.config({loader:!0});avalon.ready(function(){avalon.scan(p.body)});"function"===typeof define&&define.amd&&define("avalon",[],function(){return avalon});avalon.noConflict=function(b){b&&q.avalon===avalon&&(q.avalon=avalon);return avalon};void 0===Z&&(q.avalon=avalon);return avalon});
